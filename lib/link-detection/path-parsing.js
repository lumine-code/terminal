...
// no filesystem validation and no xterm.js buffer/line-wrapping logic; both
// belong to `provider.js`.
//
...
exports.MAX_RESOLVED_LINK_LENGTH =
  exports.MAX_RESOLVED_LINKS_PER_LINE =
  exports.MAX_LINE_LENGTH =
  exports.fallbackPathMatchers =
  exports.winDrivePrefix =
    void 0;
...
const winLocalLinkClause =
  "(?:(?:" +
  `(?:${exports.winDrivePrefix}|${RegexPathConstants.WinOtherPathPrefix})` +
  "|(?:" +
  RegexPathConstants.WinExcludedStartPathCharactersClause +
...
exports.MAX_RESOLVED_LINKS_PER_LINE = 10;
exports.MAX_RESOLVED_LINK_LENGTH = 1024;
