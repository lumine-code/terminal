...
var _TerminalElement_instances, _TerminalElement_mainResizeObserver, _TerminalElement_mainContentRect, _TerminalElement_terminalIntersectionObserver, _TerminalElement_terminalInitiallyVisible, _TerminalElement_fitAddon, _TerminalElement_searchAddon, _TerminalElement_prioritizedPrefixes, _TerminalElement_ptyMeta, _TerminalElement_shouldPrioritizeBinding, _TerminalElement_keymapHasPendingPartialMatches, _TerminalElement_keyboardEventMatchesKeybinding, _TerminalElement_createTerminal;
...
_TerminalElement_mainResizeObserver = new WeakMap(), _TerminalElement_mainContentRect = new WeakMap(), _TerminalElement_terminalIntersectionObserver = new WeakMap(), _TerminalElement_terminalInitiallyVisible = new WeakMap(), _TerminalElement_fitAddon = new WeakMap(), _TerminalElement_searchAddon = new WeakMap(), _TerminalElement_prioritizedPrefixes = new WeakMap(), _TerminalElement_ptyMeta = new WeakMap(), _TerminalElement_instances = new WeakSet(), _TerminalElement_shouldPrioritizeBinding = function _TerminalElement_shouldPrioritizeBinding(kb, ancestorChain) {
    ...
    if (result) {
        log.log('Assuming control of keybinding:', keystroke, 'because it matches at least one Lumine binding');
    }
    return result;
    ...
    if (config.Config.get('xterm.webgl')) {
        let webglAddon = null;
        try {
            webglAddon = new addonWebgl.WebglAddon();
        }
        catch (err) {
