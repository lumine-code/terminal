...
class FindPalette {
  ...
  constructor(searchAddon) {
    ...
    this.subscriptions.add(
      atom.config.onDidChange("terminal.appearance", updateSearchTheme),
      atom.themes.onDidChangeActiveThemes(updateSearchTheme),
      atom.styles.onDidAddStyleElement(updateSearchTheme),
    );
  }
