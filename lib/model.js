...
class TerminalModel {
  ...
  // - `isModified` and `onDidChangeModified` report unsaved work. The tab bar's
  //   dot is only one reader: `tabs:close-saved-tabs` skips a modified item, so
  //   borrowing the dot to mean “output you haven't seen” made a terminal
  //   survive that command depending on whether output happened to arrive while
