...
//
// A suitably-configured third-party shell integration may emit these sequences
// to mark command boundaries. Lumine's injected scripts use OSC 633 instead.
...
class ShellIntegration {
  constructor(terminal, { enabled = () => true } = {}) {
...
module.exports.ShellIntegrationAddon = require("./shell-integration/addon").ShellIntegrationAddon;
module.exports.getShellIntegrationInjection =
  require("./shell-integration/index").getShellIntegrationInjection;
