...
class Terminal {
  ...
  static describeFocus(target) {
    ...
    if (item) return TerminalModel.is(item) ? null : { type: "item", item };
  ...
  static deactivate() {
    ...
    this.previousFocus = null;
    TerminalElement.mcpBridge = null;
  }
  ...
  static consumeMcpBridge(mcpBridge) {
    TerminalElement.mcpBridge = mcpBridge;
    return new Disposable(() => {
      if (TerminalElement.mcpBridge === mcpBridge) {
        TerminalElement.mcpBridge = null;
      }
    });
  }
