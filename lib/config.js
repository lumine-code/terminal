    ...
    terminal: {
      ...
      properties: {
        activeTerminalIndicator: {
          ...
          description: `Character(s) to prepend to the active terminal's tab title. Empty by default; the active tab is already highlighted by the tab bar.`,
          type: "string",
          default: "",
          order: 0,
        },
    ...
    appearance: {
      ...
      properties: {
        fontFamily: {
          title: "Font Family",
          description:
            "Font to use in terminals. Can be left blank unless you want something other than your editor font.",
          order: 0,
          type: "string",
        ...
        theme: {
          title: "Color Theme",
          description:
            "Which set of colors to use in the terminal.  **Stylesheet** lets you (or a theme) specify terminal colors in a stylesheet; **Custom** prefers the values specified in the section below; and the remaining values are legacy preset themes.\n\nIf you choose **Custom**, expand the **Custom Theme Colors** heading to modify individual colors.",
          type: "string",
          enum: [
            {
              value: "Stylesheet",
              description:
                "Stylesheet (uses colors defined in your syntax theme or user stylesheet)",
            },
            {
              value: "Config",
